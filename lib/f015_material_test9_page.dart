...
class MaterialTest9Page extends HookConsumerWidget {
  ...
  List<Widget> createListViewRow(List<TextEditingController> controllers) {
    return [
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    var listViewRow = createListViewRow(mainTextFieldControllers.value);
          ...
          child: GestureDetector(
              ...
              child: ListView(
                  ...
                  children: [
                    ...
                    for (int i=0; i < listViewRow.length; i++) ... {
                      listViewRow[i],
                    }
                  ]
              )
